...
public class SpringECI {
    public static void main(String[] args) throws ClassNotFoundException, MalformedURLException, InvocationTargetException, IllegalAccessException {
        ...
        URL serviceurl = new URL("http://localhost:8080/App/greeting?name=JuanDavid");
        ...
        if (ms != null) {
            ...
            System.out.println("Service Response: " + ms.invoke(null, argsToPass));
        } else {
            System.out.println("Servicio not found: " + serviceName);
        }
    }
